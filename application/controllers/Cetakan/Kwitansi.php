...
//     }
    public function gabungan(){
        ...
        $grand_total = $pembayaran_lingkungan->total+$pembayaran_air->total;
        ...
        $pembayaran_lingkungan->total = number_format($pembayaran_lingkungan->total,0,",",".");
        $pembayaran_air->denda = number_format($pembayaran_air->denda,0,",",".");
        $pembayaran_air->diskon = number_format($pembayaran_air->diskon,0,",",".");
        $pembayaran_air->total = number_format($pembayaran_air->total,0,",",".");
        // echo("<pre>");
        ...
        if($project->id == 17){
                $this->pdf->load_view("proyek/cetakan/kwitansi_gabungan_citragrand_CBD",[
                        "unit"                  => $unit,
                        "meter"                 => $meter,
