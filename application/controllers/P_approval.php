...
class P_approval extends CI_Controller
{
	...
	public function ajax_approve(){
		echo json_encode($this->m_approval->approve($this->input->post("id"),$this->input->post("deskripsi"),1));// 1 approve, 0 reject
	}
	public function ajax_reject(){
		echo json_encode($this->m_approval->approve($this->input->post("id"),$this->input->post("deskripsi"),0));// 1 approve, 0 reject
	}
