...
class P_master_sub_golongan extends CI_Controller
{
    ...
    public function add()
    {
        ...
        $this->load->view('proyek/master/sub_golongan/add', ['dataGolongan' => $dataGolongan, 'dataService' => $dataService]);
        $this->load->view('core/body_footer');
        $this->load->view('core/footer');
    }
    ...
    public function edit()
    {
        ...
        if ($this->m_sub_golongan->cek($this->input->get('id'))) {
            ...
            $this->load->view('proyek/master/sub_golongan/edit', ['data' => $data, 'dataGolongan' => $dataGolongan, 'dataService' => $dataService, 'dataSelect' => $dataSelect, 'dataRange' => $dataRange]);
            $this->load->view('core/body_footer');
            $this->load->view('core/footer');
        } else {
