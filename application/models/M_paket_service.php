...
class m_paket_service extends CI_Model
{
    ...
    public function get_log($id)
    {
        ...
        SELECT
            ...
            REPLACE(CONVERT(varchar, CAST(paket_service.biaya_satuan_registrasi AS money), 1),'.00','') as [biaya_satuan_registrasi],
            REPLACE(CONVERT(varchar, CAST(paket_service.biaya_satuan_tanpa_registrasi AS money), 1),'.00','') as [biaya_satuan_tanpa_registrasi],
            case
    ...
    public function save($dataTmp)
    {
        ...
        [
            ...
            'biaya_satuan_registrasi' => $this->m_core->currency_to_number($dataTmp['biaya_satuan_registrasi']),
            'biaya_satuan_tanpa_registrasi' => $this->m_core->currency_to_number($dataTmp['biaya_satuan_tanpa_registrasi']),
