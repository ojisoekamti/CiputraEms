...
class m_unit extends CI_Model
{
    ...
    public function getSelect($id)
    {
        ...
        $query = $this->db->query("
            SELECT
                ...
                unit.product_category_id as produk_kategori,
                ...
                air.tgl_aktif as air_tanggal_aktif,
                air.tgl_putus as air_tanggal_putus,
                ...
                pl.tgl_aktif as pl_tangal_aktif,
                pl.tgl_nonaktif as pl_tangal_putus,
    ...
    public function getPT()
    {
        $project = $this->m_core->project();
        $query = $this->db->query('
            SELECT * FROM PT where active =1    order by id asc
        ');
    ...
    public function getMetodePenagihan()
    {
        $project = $this->m_core->project();
        $query = $this->db->query('
            SELECT * FROM metode_penagihan   order by id asc
        ');
    ...
    public function getProductCategory()
    {
        $project = $this->m_core->project();
        $query = $this->db->query("
            SELECT * FROM product_category where active =1 and project_id = $project->id   order by id asc
        ");
    ...
    public function edit($dataTmp)
    {
        ...
        $dataUnitLingkungan =
            [
                'aktif' => $dataTmp['lingkungan_aktif'],
                'tgl_aktif' => $dataTmp['tgl_aktif_lingkungan'] ? $dataTmp['tgl_aktif_lingkungan'] : null,
        ...
        //    echo '<pre>';
        //    print_r($dataSelectMetodePenagihan);
        //    echo '</pre>';
