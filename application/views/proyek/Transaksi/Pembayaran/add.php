			...
			$.ajax({
				...
				success: function(abc) {
					...
					if(abc.parameter == 1){
						...
						var a = unformatNumber($("#tbody_unit").find("tr").eq(0).find("td").eq(11).html()) * abc.nilai;
						console.log(unformatNumber($("#tbody_unit").find("tr").eq(1).find("td").eq(9).html()));
						console.log(a);
			...
			$.ajax({
				...
				success: function(data) {
					...
					$.each(data.tagihan_lingkungan, function(k, v) {
						total_row = v.nilai_tagihan + v.nilai_denda + 0 - (v.view_pemutihan_nilai_tagihan + v.view_pemutihan_nilai_denda);
						total += v.nilai_tagihan + v.nilai_denda + 0 - (v.view_pemutihan_nilai_tagihan + v.view_pemutihan_nilai_denda);
						sisa_tagihan = v.nilai_tagihan - v.view_pemutihan_nilai_tagihan;
						sisa_denda = v.nilai_denda - v.view_pemutihan_nilai_denda;
						table += "<tr service_id='"+v.service_id+"' is_tagihan='"+v.is_tagihan+"'>"+
							"<td>" +
							"<input type='checkbox' class='check_bayar flat table-check' name='check_bayar[]' value='" + v.service_id + "|" + v.service_jenis_id + "|" + v.tagihan_id + "|" + v.nilai_tagihan + "|" + v.nilai_denda + "|" + 0 + "|" + v.view_pemutihan_nilai_tagihan + "|" + v.view_pemutihan_nilai_denda + "'>" +
							"</td>" +
							"<td>" +
							"<input type='checkbox' class='check_deposit flat table-check' name='check_deposit[]' value='" + v.service_id + "|" + v.service_jenis_id + "|" + v.tagihan_id + "|" + v.nilai_tagihan + "|" + v.nilai_denda + "|" + 0 + "|" + v.view_pemutihan_nilai_tagihan + "|" + v.view_pemutihan_nilai_denda + "'>" +
							"</td>" +
							"<td class='text-right'>" +
							v.periode +
							"</td>" +
							...
							"<td class='td_bisa_bayar text-right col-md-2 col-lg-2'>" +
								"<input class='text-right bisa_bayar form-input col-md-12 col-lg-12' max='"+total_row+"' name='bisa_bayar' value='"+formatNumber(total_row)+"'>"+
							"</td>"+
					...
					$.each(data.tagihan_loi, function(k, v) {
						...
						table += "<tr service_id='"+0+"' is_tagihan='"+v.is_tagihan+"'>"+
							"<td>" +
							"<input type='checkbox' class='check_bayar flat table-check' name='check_bayar[]' value='"+v.service_id+"|"+v.service_jenis_id+"|"+v.tagihan_id+"|"+v.nilai_tagihan+"|"+0+"|"+0+"|"+0+"|"+0+"'>" +
							"</td>" +
							"<td>" +
							"<input type='checkbox' class='check_deposit flat table-check' name='check_deposit[]' value='"+v.tagihan_id+"'>" +
							"</td>" +
							"<td class='text-right'>" + v.periode + "</td>" +
							"<td>LOI</td>" +
							"<td class='text-right'>" +
					...
					$.ajax({
						...
						url: "<?= site_url() ?>/Transaksi/P_deposit/ajax_get_deposit/" + $("#unit").val(),
						dataType: "json",
						success: function(data) {
