...
<div style="float:right">
  <h2>
    <button class="btn btn-primary" onClick="window.location.href='<?= site_url() ?>/Transaksi/P_transaksi_meter_air/add'">
    ...
    <button class="btn btn-success" onClick="window.location.href='<?= site_url() ?>/Transaksi/P_transaksi_meter_air'">
