			...
			<tr>
			   ...
			   <th>Kode</th>
                ...
                foreach ($data as $key => $v) {
                    ...
                    echo"<td>$v[code]</td>";
                    echo"<td>$v[name]</td>";
                    echo "<td>$v[jumlah_hari]</td>";
                    echo"<td>$v[description]</td>";
                    echo '<td>';
                    echo $v['active'] ? 'Aktif' : 'Tidak Aktif';
                    echo '</td>';
                    echo "<td><a href='".site_url()."/P_master_paket_tvi/add_paket?id=$v[id]' class='btn btn-sm btn-primary col-md-12'> <i class='fa fa-plus'>Tambah</i></a></td>";
                    echo"
                        <td class='col-md-1'>
