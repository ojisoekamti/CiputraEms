...
?>
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="biaya_satuan_registrasi" name="biaya_satuan_registrasi" required="required" class="form-control col-md-7 col-xs-12 currency" value="<?=$data_select->biaya_satuan_registrasi; ?>" disabled>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="biaya_satuan_tanpa_registrasi" name="biaya_satuan_tanpa_registrasi" required="required" class="form-control col-md-7 col-xs-12 currency" value="<?=$data_select->biaya_satuan_tanpa_registrasi; ?>" disabled>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<div class="">
					<label>
						<input id="status" type="checkbox" class="js-switch" name="status" value="1" <?=$data_select->active == 1 ? 'checked' : ''; ?>
						disabled/> Aktif
					</label>
				</div>
			</div>
...
<script type="text/javascript">
	...
	$.each($(".currency"), function (index, currency) {
		...
		$("#btn-update").click(function () {
			...
			$("#biaya_satuan_registrasi").removeAttr("disabled");
			$("#biaya_satuan_tanpa_registrasi").removeAttr("disabled");
		...
		$("#btn-cancel").click(function () {
			...
			$("#biaya_satuan_registrasi").attr("disabled", "");
			$("#biaya_satuan_tanpa_registrasi").attr("disabled", "");
