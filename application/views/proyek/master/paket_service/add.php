...
<div class="x_content">
	<br>
	<form id="form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" method="post" action="<?=site_url(); ?>/P_master_paket_service/save">
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<select type="text" id="jenis_service" required="required" class="select2 form-control col-md-7 col-xs-12" name="jenis_service"
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="nama_pekerjaan" name="nama_pekerjaan" required="required" class="form-control col-md-7 col-xs-12">
			</div>
		</div>
		...
		<div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="jenis_pembayaran">Biaya Satuan dengan Registrasi<span class="required">*</span>
			</label>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="biaya_satuan_registrasi" name="biaya_satuan_registrasi" required="required" class="form-control col-md-7 col-xs-12 currency">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-3 col-sm-3 col-xs-12" for="jenis_pembayaran">Biaya Satuan tanpa Registrasi<span class="required">*</span>
			</label>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="biaya_satuan_tanpa_registrasi" name="biaya_satuan_tanpa_registrasi" required="required" class="form-control col-md-7 col-xs-12 currency">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<input type="text" id="minimal_langganan" name="minimal_langganan" required="required" class="form-control col-md-7 col-xs-12 currency">
			</div>
		</div>
		<div id="view_biaya_registrasi">
			<div class="form-group">
				...
				<div class="col-md-5 col-sm-6 col-xs-12">
					<input type="text" id="biaya_registrasi" name="biaya_registrasi" required="required" value="0" disabled class="form-control col-md-7 col-xs-12 currency">
				</div>
			</div>
		</div>
		<div id="view_biaya_pemasangan">
			<div class="form-group">
				...
				<div class="col-md-5 col-sm-6 col-xs-12">
					<input type="text" id="biaya_pemasangan" name="biaya_pemasangan" required="required" value="0" disabled class="form-control col-md-7 col-xs-12 currency ">
				</div>
			</div>
		</div>
