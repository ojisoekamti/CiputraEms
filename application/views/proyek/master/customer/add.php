	...
	<form id="form" class="form-horizontal form-label-left" method="post" action="<?=site_url(); ?>/P_master_customer/save">
		<div class="col-md-6 col-xs-12">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" name="nama_npwp" class="form-control" placeholder="Masukkan Nomor NPWP" required> 
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" class="form-control" name="nomor_npwp" data-inputmask="'mask': '99.999.999.9-999.999'" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Alamat NPWP</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<textarea name="alamat_npwp" class="form-control" rows="3" placeholder='Masukkan Alamat NPWP' required></textarea>
				</div>
			</div>
			<div class="form-group">
		...
		<div class="col-md-6 col-xs-12">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" class="form-control" placeholder="Masukkan Home Phone" name="home_phone" required>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3 col-sm-3 col-xs-12">Office Phone</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" class="form-control" placeholder="Masukkan Office Phone" name="office_phone" required>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" class="form-control" placeholder="Masukkan Mobile Phone 2" name="mobile_phone_2" required>
				</div>
			</div>
			<div class="form-group">
