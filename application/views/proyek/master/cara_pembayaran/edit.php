	...
	<form id="form-cara-pembayaran" autocomplete="off" class="form-horizontal form-label-left" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input type="number" id="va_bank" name="va_bank" required="required" class="form-control col-md-7 col-xs-12 disabled-form" placeholder="Masukkan Bank Merchant" value="<?=$dataSelected->va_bank?>" disabled>
            </div>
            <div class="col-md-3 col-sm-3 col-xs-12">
                <input type="number" id="va_merchant" name="va_merchant" required="required" class="form-control col-md-7 col-xs-12 disabled-form" placeholder="Masukkan Sub Bank Merchant" value="<?=$dataSelected->va_merchant?>" disabled>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="biaya_admin" id="label_biaya_admin">Max Digit VA</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" id="max_digit" name="max_digit" required="required" class="form-control col-md-7 col-xs-12 disabled-form" placeholder="Masukkan Max Digit (Sub Bank Merchant + 8)" value="<?=$dataSelected->max_digit?>" disabled>
            </div>
        </div>
        <div class="form-group">
