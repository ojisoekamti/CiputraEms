	...
	<table id="tableDT2" class="table table-striped jambo_table bulk_action">
		...
		<tbody>
            ...
            foreach ($data as $key => $v) {
				...
				echo "<td>$v[kode]</td>";
				echo "<td>$v[nama]</td>";
				echo "<td>".number_format($v['biaya_registrasi'])."</td>";
				echo "<td>".number_format($v['harga_jasa'])."</td>";
				echo "<td>".number_format($v['biaya_prakiraan'])."</td>";
                echo "
                        <td class='col-md-1'>
	...
	<script>
		function confirm_modal(id) {
			...
			document.getElementById('delete_link_m_n').setAttribute("href",
				"<?= site_url('P_master_paket_loi/delete?id=" + id + "'); ?>");
