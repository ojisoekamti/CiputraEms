				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						<div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" class="form-control currency" name="sisa_deposit" value="<?=number_format($dataSelect->sisa_deposit)?>" id="sisa_deposit" disabled>
							</div>
						</div>
                        <div class="form-group two ">
						...
						<div class="form-group two start ">
							...
							<div class="col-md-4 col-sm-4 col-xs-12">
								<label style="padding-top: 6px;">
									...
									<input id="hasil_aktifasi" type="checkbox" name="hasil_aktifasi" class="js-switch" value="1" />
