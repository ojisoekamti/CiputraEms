		...
		<div id="view_data">
			...
			<div class="col-md-6 col-sm-6 col-xs-12 paket_internet">
				...
				<div class="form-group two">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" name="" readonly="" id="subtotal" name="subtotal" value="<?=number_format($dataSelect->biaya_registrasi+$dataSelect->harga_jasa+$dataSelect->biaya_prakiraan)?>" class="form-control currency">
					</div>
				</div>
			</div>
			<div class="clearfix"></div>
				...
				<div class="col-md-12">
					...
					<div class="col-md-6">
						...
						<div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="totalpaket" readonly="" value="<?=number_format($dataSelect->biaya_registrasi+$dataSelect->harga_jasa+$dataSelect->biaya_prakiraan)?>" id="totalpaket" class="form-control currency">
							</div>
						</div>
						<div class="form-group two">
						...
						<div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="total_bayar" readonly="" id="total_bayar" value="<?=number_format($dataSelect->biaya_registrasi+$dataSelect->harga_jasa+$dataSelect->biaya_prakiraan+$dataSelect->deposit_masuk)?>" class="form-control currency">
							</div>
						</div>
					</div>
				</div>
