		...
		<div id="view_data">
			...
			<div class="col-md-6 col-sm-6 col-xs-12 paket_internet">
				...
				<div class="form-group two">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" name="biaya_registrasi" value="0" id="biaya_registrasi" readonly class="form-control ">
					</div>
				</div>
                <div class="form-group two">
					<label class="control-label col-md-3 col-sm-3 col-xs-12">Harga Pengurusan Jenis (Rp)</label>
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" name="harga_jasa" value="0" id="harga_jasa" readonly class="form-control currency">
					</div>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12 paket_internet">
				<div class="form-group two">
					...
					<div class="col-md-9 col-sm-9 col-xs-12">
						<input type="text" name="biaya_prakiraan" readonly="" id="biaya_prakiraan" value="0" class="form-control currency">
					</div>
				</div>
				<div class="form-group two">
				...
				<div class="col-md-12">
					<div class="col-md-6">
						<div class="form-group two ">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class='input-group date '>
									...
									id="tanggal_document" value='<?= date('d-m-Y') ?>' disabled readonly placeholder="Masukkan Tanggal Document"> <span class="input-group-addon">
						...
						<div class="form-group two start ">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class='input-group date '>
									<input type="text" class="form-control datetimepicker" name="tanggal_rencana_survei" 
						...
						<div class="form-group two start ">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class='input-group date '>
									...
									id="tanggal_pemasangan_mulai" disabled placeholder="Masukkan Tanggal Rencana Pasang Instalasi"> <span class="input-group-addon">
										<span class="glyphicon glyphicon-calendar"></span>
									</span>
								</div>
							</div>
						...
						<div class="form-group two start ">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class='input-group date '>
									...
									id="tanggal_aktifasi" disabled placeholder="Masukkan Tanggal Rencana Serah Terima"> <span class="input-group-addon">
										<span class="glyphicon glyphicon-calendar"></span>
									</span>
								</div>
							</div>
					...
					<div class="col-md-6">
						<div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class='input-group date '>
									...
									id="expired_date" disabled placeholder="Masukkan Tanggal Expired"> <span class="input-group-addon">
										<span class="glyphicon glyphicon-calendar"></span>
									</span>
								</div>
							</div>
						...
						<div class="form-group two">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<input type="text" name="deposit_masuk" id="deposit_masuk" readonly="" value="0" class="form-control currency">
							</div>
						</div>
						<div class="form-group two">
...
<script type="text/javascript">
	...
	$("#jenis").change(function(){
		...
		$.ajax({
			...
			success: function (data) {
				...
				$.each(data, function (key, val) {
					$("#paket").append("<option value='" + val.id + "|" + val.kode + "|" + val.biaya_registrasi + "|" + val.harga_jasa +"|" + val.biaya_prakiraan + "|" + val.deposit_min +"'>" + val.nama + "</option>");
				});
			}
		});
	});
	...
	$("#paket").change(function(){
		...
		$("#deposit_masuk").val(currency(deposit_min));
		...
		var total_bayar = total + parseInt(deposit_min);
