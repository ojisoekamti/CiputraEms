                ...
                <table class="table table-striped jambo_table bulk_action tableDT">
                    ...
                    <tbody>
                        ...
                        foreach ($data as $key => $v) {
                            ...
                            echo "<td>$v[name]</td>";
                            // echo "<td>$v[status_bayar_registrasi]</td>";
                            // echo "<td></td>";
                            // echo "<td></td>";

                            echo "
                            <td class='col-md-1'>
                            <a href='" . site_url() . "/transaksi_lain/P_registrasi_layanan_lain/cetak?id=$v[registrasi_id]&unit_id=$v[unit_id]' class='btn btn-sm btn-primary col-md-12'>
                                Cetak Kwitansi
                            </a>
                            </td>
                        ";
...
<script>
    function confirm_modal(id) {
        ...
        document.getElementById('delete_link_m_n').setAttribute("href", "<?= site_url('P_registrasi_layanan_lain/delete?unit_id=" + unit_id + "'); ?>");
