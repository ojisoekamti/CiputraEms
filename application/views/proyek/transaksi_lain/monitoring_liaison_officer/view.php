            ...
            <table class="table table-striped jambo_table bulk_action tableDT">
                ...
                <?php
                    ...
                    foreach($data as $v){
                      ...
                      if($v['status_dokumen'] == '6'){
                        echo "<a title='Payment' href='".site_url()."/transaksi_lain/P_monitoring_liaison_officer/pembayaran1?id=$v[id]' class='btn btn-xs btn-primary'>
                                <i class='fa fa-money'></i>
                              </a>";
                      }elseif($v['status_dokumen'] == '8'){
                        echo "<a title='Payment' href='".site_url()."/transaksi_lain/P_monitoring_liaison_officer/pembayaran2?id=$v[id]' class='btn btn-xs btn-primary'>
                                <i class='fa fa-money'></i>
                              </a>";
                      }
                            ...
                            <li>
                              <div class="block">
                                ...
                                <div class="block_content">
                                  ...
                                  <h5>
                                    <a>Tanggal Registrasi : <?= $v['tanggal_document']?></a>
                                  </h5>
                                </div>
                              </div>
                            </li>
